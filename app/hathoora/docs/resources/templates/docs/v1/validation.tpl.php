<div class="box">
   ...
   <pre>
    ...
    <p>
        If you are using a <a href="/docs/v1/model#modelSAR">ModelSAR class</a>, then same rules apply at above, however you have the convineance of passing an object instead of array of values.
    </p>
