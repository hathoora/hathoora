<div class="box">
    ...
    <p>
        Services in Hathoora PHP Framework are lazy loaded. They are not instantiated until they are called. You can define services in <a href="/docs/v1/configuration#configuration">configuration</a> like so:
    </p>
    <pre>
        <code class="hljs Ini">
            services:
    ...
    <p>
        Services are accessed from <a href="/sample/view/docs/container">container</a>. Container is already available in components like <a href="/docs/v1/controller">contoller</a>, <a href="/docs/v1/model">model</a>, <a href="/docs/v1/database">database</a> etc already extend container.
    </p>
    <p>
