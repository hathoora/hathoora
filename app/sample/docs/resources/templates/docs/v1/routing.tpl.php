<div class="box">
    ...
    <p>
        However Hathoora PHP Frameworks allows you to change the domain identifier (using <a class="e" href="/docs/v1/configuration#applicationmultiple">regex patterns</a>) which would change the meaning of URI.</p>
    <p>
