<div class="box">
        ...
        <code class="hljs Ini">
            ...
            app/
                ...
                sample      
                    ...
                    sampleSite/                 <-- name of second supported application
                        ...
    ...
    <ul>
        <li><code class="inline">Config</code>: stores application specific configuations which are discussed in more details <a href="/sample/docs/view/configuration#configuration">here</a>.</li>
        <li><code class="inline">Controller</code>: stores application specific <a href="/sample/docs/view/controller">controllers</a> to intercept requests. </li>
        <li><code class="inline">Resources</code>: stores application specific <a href="/sample/docs/view/view">templates</a> and <a href="/sample/docs/view/assets">assets</a>.</li>
        <li><code class="inline">Model</code>: stores application specific <a href="/sample/docs/view/model">models</a> or logic. This can be named to anything.</li>
    </ul>
    ...
    <p>
        This is public facing directoy which should be <a href="/sample/docs/view/installation#apache">configured</a> in your webserver.
    </p> 
