<div class="box">
    ...
    <h2>Prerequisite</h2>
    <p>
        Prerequisite for this section that were previously discussed in <a href="/sample/docs/view/routing">routing & pretty URLs</a> section:
    </p>
    <ul>
        <li><a href="/sample/docs/view/routing#defaultController">Default Controller</a></li>
        <li><a href="/sample/docs/view/routing#defaultAction">Default Action</a></li>
        <li><a href="/sample/docs/view/routing#camelcase">Camel Case Action Names</a></li>
        <li><a href="/sample/docs/view/routing#uri">Note About URI</a></li>
    </ul>
