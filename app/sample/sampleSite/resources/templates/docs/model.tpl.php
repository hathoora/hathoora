<div class="box">
    ...
    <h2>Basics</h2>
    <p>
        Model class in Hathoora PHP Framework is nothing more than the extension of <a href="/sample/docs/view/container">container</a> and provides an easy way to get database connection using <code class="inline">getDBConnection()</code> function.
    </p>
    <p>
    ...
    <p>
        For further reading, checkout <a href="/sample/docs/view/database">database</a> and <a href="/sample/docs/view/grid">grid</a>.
    </p>
    ...
    <ul>
        ...
        <li><code class="e">postSave()</code>: a function that is called when you save an object. This is useful of adding events for <a href="/sample/docs/view/listeners">listeners</a> to do something.</li>
    </ul>
    <p>
    ...
    <p>
        In this example we are building query using components of <a href="/sample/docs/view/grid">grid</a>.
    </p>
    <br/>
    <p>
        <a name="#modelSAR_new"></a>
