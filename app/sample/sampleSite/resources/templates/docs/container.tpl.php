<div class="box">
    ...
    <p>
        Some components like <a href="/sample/docs/view/controller">contoller</a>, <a href="/sample/docs/view/model">model</a>, <a href="/sample/docs/view/database">database</a> etc already extend container. If you need to access container outside these components then you:
    </p>
    <ul>
    ...
    <ul>
        ...
        <li><a href="/sample/docs/view/services">services</a></li>
