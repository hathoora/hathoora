<div class="box">
    ...
    <p>
        You can define listeners in <a href="/sample/docs/view/configuration#configuration">configuations</a> like so:
    </p>
    <pre>
        <code class="hljs Ini">
            # File config.yml
    ...
    <p>
        For all above kernel events, the <a href="#subject">subject</a> passed to listeners is <a href="/sample/docs/view/container">container</a>.
    </p>
</div>